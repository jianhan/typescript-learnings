 ...
 * @LastEditTime: 2020-06-04 21:44:05
...
var twoArgs = function (x, y) {
    console.log(x, y, '-----');
    return x * y;
};
var oneArg = function (x) {
    console.log(x, '-----');
    return x * 2;
};
var twoArgsRes = ["1", "2", "3"].map(twoArgs);
var oneArgRes = ["1", "2", "3"].map(oneArg);
...
var parseIntResult = ["1", "2", "3"].map(parseInt);
...
var parseIntUnaryResult = ["1", "2", "3"].map(unary(parseInt));
console.log(parseIntUnaryResult);
